...
public class VHDLProcessStatementImpl extends ASTWrapperPsiElement implements VHDLProcessStatement {
  ...
  @Override
  @NotNull
  public List<VHDLIProcessLabel> getIProcessLabelList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, VHDLIProcessLabel.class);
  }
  ...
  @Override
  @NotNull
  public VHDLProcessSensitivityList getProcessSensitivityList() {
    return findNotNullChildByClass(VHDLProcessSensitivityList.class);
  }
