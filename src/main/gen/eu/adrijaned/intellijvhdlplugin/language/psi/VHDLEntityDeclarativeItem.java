...
public interface VHDLEntityDeclarativeItem extends PsiElement {
  ...
  @Nullable
  VHDLIPSLClockDeclaration getIPSLClockDeclaration();
  ...
  @Nullable
  VHDLISharedVariableDeclaration getISharedVariableDeclaration();
