...
public class VHDLConditionalExpressionImpl extends ASTWrapperPsiElement implements VHDLConditionalExpression {

  public VHDLConditionalExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
