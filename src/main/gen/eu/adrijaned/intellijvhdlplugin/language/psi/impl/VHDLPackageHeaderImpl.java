...
public class VHDLPackageHeaderImpl extends ASTWrapperPsiElement implements VHDLPackageHeader {

  public VHDLPackageHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VHDLVisitor visitor) {
    visitor.visitPackageHeader(this);
  }
