...
public class VHDLBlockStatementImpl extends ASTWrapperPsiElement implements VHDLBlockStatement {
  ...
  @Override
  @NotNull
  public List<VHDLIBlockLabel> getIBlockLabelList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, VHDLIBlockLabel.class);
  }

  @Override
  @Nullable
  public VHDLIGuardCondition getIGuardCondition() {
    return findChildByClass(VHDLIGuardCondition.class);
  }
